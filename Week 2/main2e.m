...
mu1=3*[2 3]';	    % true mean value
SIGMA1=[1  0.2
    0.2 1 ];   % true covariance matrix

mu2=-2.5*[2 3]';	    % true mean value
SIGMA2=[1 -0.3
    -0.3 1];   % true covariance matrix
...
if verLessThan('matlab','8.4')
    ...
    tmp = cellfun(@str2num,get(gca,'xticklabel'));
    set(gca,'xticklabel',num2str(-tmp));
end
ylabel('^~x_2')
xlabel('p(^~x_2)')
title('Marginal Distribution after transf.');
