...
minError=[minError best_ever];
figure(3)
hold off
plot(minError)
title('Error for different dimensions of data and optimal parameters Order=4,2,1,5,6,7')
xlabel('Number of dimensions reduced')
ylabel('Test error')
