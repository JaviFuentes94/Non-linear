...
figure(2)
title('Mean square error over noise level')
subplot(1,2,1)
plot(noiselevels,vErrors)
xlabel('Level of noise')
ylabel('Mean squared error')
subplot(1,2,2)
loglog(noiselevels,vErrors)
xlabel('Log of the level of noise')
ylabel('Log of the mean squared error')
%%%%%%%%%%%%%%%%%%%%%% Results %%%%%%%%%%%%%%%%%%%
